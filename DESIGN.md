...
- Mega menu: text-only nested IA (Colección Virtual Notafilia, Recursos). No images in the bar or panels. Filipinas, Colombia, Ecuador, and Glosario are live links; other labels are placeholders. Mobile is a left drawer with accordion submenus.
