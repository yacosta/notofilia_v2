...
export const seriesSources: CatalogSource[] = [
  ...
  },
  {
    ...
    es: 'Wikipedia — Peso filipino emitido por el gobierno japonés («Mickey Mouse money»)',
    en: 'Wikipedia — Japanese government-issued Philippine peso (“Mickey Mouse money”)',
    note: {
      es: 'Papel fiduciario de ocupación; hiperinflación y el apodo popular.',
      en: 'Occupation fiat paper; hyperinflation and the popular nickname.',
    },
  },
];
...
export const seriesCopy = {
  es: {
    ...
    intro: [
      'El Philippine National Bank, creado por la Ley n.º 2612 de 1916, emitió billetes de circulación grabados en Washington. Esta vitrina abre con un 5 pesos de esa serie —McKinley, sello azul, reverso naranja— y continúa con los Certificados del Tesoro de la serie de liberación.',
      'Los Certificados del Tesoro de la Serie Victory n.º 66 fueron el último papel moneda impreso bajo la administración de Estados Unidos en Filipinas. Los grabó el Bureau of Engraving and Printing en pliegos de diez billetes, con reemplazos marcados con una estrella al estilo estadounidense.',
      'Según el BEP, el «n.º 66» se eligió porque era la edad que se le atribuía al presidente Manuel L. Quezon al momento de su fallecimiento. Quezon nació el 19 de agosto de 1878 y murió el 1 de agosto de 1944, a los 65 años —meses antes de la liberación—, de modo que el número conmemora una edad que no llegó a cumplir. El 20 de octubre de 1944, al desembarcar las fuerzas de Douglas MacArthur en Leyte, llegaron cajas de estos certificados, puestos en circulación ese mismo día. El total emitido de la serie fue de ₱1.019.544.000.',
      'Ese papel debía sustituir el circulante de la ocupación militar japonesa: moneda fiduciaria sin respaldo metálico, devaluada por la hiperinflación y popularmente llamada «dinero Mickey Mouse». El certificado Victory volvía a prometer, en el anverso, pesos de plata o moneda de curso legal de Estados Unidos de valor equivalente.',
      ...
      'En 1949, al crearse el Central Bank of the Philippines, parte de la serie recibió en el reverso la sobrecarga «CENTRAL BANK OF THE PHILIPPINES» (Pick 117 y siguientes). Los 500 pesos se retiraron el 25 de agosto de 1954, mediante la Ley de la República n.º 1191, con un plazo de canje de seis meses (desmonetización prevista para el 24 de febrero de 1955). La Ley de la República n.º 1516, de 16 de junio de 1956, prorrogó ese canje hasta el 31 de diciembre de 1957. El resto, por la Circular n.º 156 de 1963 del Banco Central, fue de curso legal hasta el 30 de julio de 1964 y pudo canjearse hasta el 30 de julio de 1967. El Bangko Sentral ng Pilipinas sitúa la llegada de la serie en 1944 y confirma que las sobrecargas de CBP siguieron siendo de curso legal hasta 1964.',
    ],
    holdingsTitle: 'Piezas de la colección',
    pnbHoldingsTitle: 'Banco Nacional de Filipinas · Serie de 1916',
    pnbHoldingsIntro:
      'Un 5 pesos de circulación del Philippine National Bank, serie A2179586A, firmas Mercado–Concepción. El serial cae en un tramo que la Ley de la República n.º 211 enumeró como reemitido por las autoridades militares japonesas.',
    victoryHoldingsTitle: 'Serie Victory n.º 66',
    holdingsIntro:
      'Cuatro certificados únicos de las ocho denominaciones oficiales, de izquierda a derecha: 1, 2, 5 y 20 pesos. El 10, el 50, el 100 y el 500 no tienen ejemplar en esta vitrina. Una segunda fotografía del 5 pesos (misma serie F00618071) no se cataloga dos veces.',
    viewNote: 'Ver la ficha',
    seriesScopeTitle: 'El alcance de la Serie Victory n.º 66',
    seriesScopeIntro: [
      'Aunque esta vitrina documenta los valores de 1, 2, 5 y 20 pesos, la emisión oficial del Bureau of Engraving and Printing comprendía ocho denominaciones, de 1 a 500 pesos (Pick 94–101). Los valores que siguen no están en la colección; se anotan para completar el tipo y no se catalogan como piezas.',
      'Esos certificados debían reemplazar el circulante colapsado de la ocupación japonesa y devolver al archipiélago un peso del Tesoro, pagadero en plata o en moneda estadounidense de valor equivalente.',
    ],
    missingDenomsTitle: 'Denominaciones de la serie fuera de esta vitrina',
    missingDenoms: [
      {
        label: '10 pesos · P#97',
        text: 'Retrato de George Washington; color principal marrón. numismatics.ph registra 16.825.600 ejemplares de la variedad Osmeña–Hernandez (series F00000001–F18870000).',
      },
      {
        label: '50 pesos · P#99',
        text: 'Retrato del general Henry Ware Lawton; color principal rosa. numismatics.ph registra 1.884.686 ejemplares de la variedad Osmeña–Hernandez (series F00000001–F02560000). El Bank Note Museum distingue además un título de tesorero (P#99b).',
      },
      {
        label: '100 pesos · P#100',
        text: 'Retrato de Fernando de Magallanes; color principal ocre. El Bank Note Museum lista tres pares: Osmeña–Hernandez (P#100a), Osmeña–Guevara (P#100b) y Roxas–Guevara (P#100c).',
      },
      {
        label: '500 pesos · P#101',
        text: 'Retrato de Miguel López de Legazpi; color principal violeta. Se retiró el 25 de agosto de 1954 (Ley de la República n.º 1191); la Ley n.º 1516 prorrogó el canje hasta el 31 de diciembre de 1957. El Bank Note Museum lista Osmeña–Hernandez (P#101a), Osmeña–Guevara (P#101b) y Roxas–Guevara (P#101c).',
      },
    ],
    signaturesTitle: 'Combinaciones de firmas',
    signaturesIntro:
      'numismatics.ph y el Standard Catalog of World Paper Money distinguen tres pares. El título impreso a la derecha —Auditor General o Treasurer— identifica la combinación. Las cuatro piezas de esta vitrina llevan Osmeña–Hernandez.',
    signaturePairs: [
      {
        label: 'Osmeña–Hernandez',
        text: 'Sergio Osmeña (presidente) y Jaime Hernandez (auditor general). Es la combinación más frecuente en casi todas las denominaciones, incluida esta vitrina. En el 500 pesos, al contrario, es la de menor tirada.',
      },
      {
        label: 'Osmeña–Guevara',
        text: 'Osmeña (presidente) y Marciano Guevara (tesorero). El Bank Note Museum la documenta sobre todo en los 100 y 500 pesos (P#100b y P#101b).',
      },
      {
        label: 'Roxas–Guevara',
        text: 'Manuel Roxas (presidente) y Guevara (tesorero), tras la transición de 1946. No se cita en los 1, 5 ni 10 pesos; sí en el 2 y el 20 (P#95b, P#98b) y en los 50, 100 y 500. Los 2 y 20 pesos de esta colección son Osmeña–Hernandez, no esa variedad más escasa.',
      },
    ],
  ...
  en: {
    ...
    intro: [
      'The Philippine National Bank, created by Act No. 2612 of 1916, issued circulating notes engraved in Washington. This case opens with a 5-peso of that series — McKinley, blue seal, orange reverse — and continues with the liberation-series Treasury Certificates.',
      ...
      'According to the BEP, “No. 66” was chosen because that was the age attributed to President Manuel L. Quezon at the time of his death. Quezon was born on 19 August 1878 and died on 1 August 1944 at 65 — months before liberation — so the series number commemorates an age he did not reach. When Douglas MacArthur’s forces landed on Leyte on 20 October 1944, they brought crates of these certificates and issued them that same day. The series totaled ₱1,019,544,000.',
      'That paper was meant to replace Japanese occupation currency: unbacked fiat notes, wrecked by hyperinflation and popularly called “Mickey Mouse” money. The Victory certificate again promised, on the face, silver pesos or United States legal-tender currency of equivalent value.',
    ...
    holdingsIntro:
      'Four unique certificates from the eight official denominations, left to right: 1, 2, 5, and 20 pesos. The 10-, 50-, 100-, and 500-peso notes have no example in this case. A second photograph of the 5-peso note (same serial F00618071) is not catalogued twice.',
    viewNote: 'Open the note page',
    seriesScopeTitle: 'The full span of Victory Series No. 66',
    seriesScopeIntro: [
      'This case records the 1-, 2-, 5-, and 20-peso values. The official Bureau of Engraving and Printing issue ran to eight denominations, from 1 to 500 pesos (Pick 94–101). The values below are not in the collection; they are listed to complete the type and are not catalogued as holdings.',
      'Those certificates were meant to replace the collapsed Japanese occupation circulating medium and restore a Treasury peso payable in silver or in United States currency of equivalent value.',
    ],
    missingDenomsTitle: 'Series denominations outside this case',
    missingDenoms: [
      {
        label: '10 pesos · P#97',
        text: 'Portrait of George Washington; brown as the main color. numismatics.ph records 16,825,600 notes of the Osmeña–Hernandez variety (serials F00000001–F18870000).',
      },
      {
        label: '50 pesos · P#99',
        text: 'Portrait of General Henry Ware Lawton; pink as the main color. numismatics.ph records 1,884,686 notes of the Osmeña–Hernandez variety (serials F00000001–F02560000). The Bank Note Museum also lists a Treasurer-title variety (P#99b).',
      },
      {
        label: '100 pesos · P#100',
        text: 'Portrait of Ferdinand Magellan; ochre as the main color. The Bank Note Museum lists three pairings: Osmeña–Hernandez (P#100a), Osmeña–Guevara (P#100b), and Roxas–Guevara (P#100c).',
      },
      {
        label: '500 pesos · P#101',
        text: 'Portrait of Miguel López de Legazpi; violet as the main color. Withdrawn on 25 August 1954 (Republic Act No. 1191); Republic Act No. 1516 extended exchange through 31 December 1957. The Bank Note Museum lists Osmeña–Hernandez (P#101a), Osmeña–Guevara (P#101b), and Roxas–Guevara (P#101c).',
      },
    ],
    signaturesTitle: 'Signature combinations',
    signaturesIntro:
      'numismatics.ph and the Standard Catalog of World Paper Money distinguish three pairings. The printed title at right — Auditor General or Treasurer — identifies the combination. All four notes in this case are Osmeña–Hernandez.',
    signaturePairs: [
      {
        label: 'Osmeña–Hernandez',
        text: 'Sergio Osmeña (President) and Jaime Hernandez (Auditor General). The most frequent pairing on nearly every denomination, including this case. On the 500-peso, that pairing is instead the smallest printing.',
      },
      {
        label: 'Osmeña–Guevara',
        text: 'Osmeña (President) and Marciano Guevara (Treasurer). The Bank Note Museum records it mainly on the 100- and 500-peso notes (P#100b and P#101b).',
      },
      {
        label: 'Roxas–Guevara',
        text: 'Manuel Roxas (President) and Guevara (Treasurer), after the 1946 transition. It is not cited on the 1-, 5-, or 10-peso notes; it does appear on the 2 and 20 (P#95b, P#98b) and on the 50, 100, and 500. The 2- and 20-peso notes in this collection are Osmeña–Hernandez, not that scarcer variety.',
      },
    ],
