...
export const contactCopy = {
  es: {
    ...
    title: 'Contacto',
    intro: '¿Tiene preguntas sobre el catálogo, el glosario o alguna pieza? Escríbanos y le responderemos con mucho gusto por correo.',
    name: 'Nombre',
    email: 'Correo electrónico',
    country: 'País de donde me escribe',
    message: 'Mensaje',
