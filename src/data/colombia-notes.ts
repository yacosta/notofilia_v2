...
export const colombiaNotes: ColombiaNote[] = [
  ...
  },
  {
    ...
    printed: {
      es: 'Imprenta de Billetes, Bogotá. Emisión de circulación del Banco de la República; fecha en el billete 7 de agosto de 1973. Formato publicado: 140 × 70 mm. Serial de ocho dígitos, sin letra de serie. González White 2019 lista esta fecha en p. 41 (Bolívar–Santander / cóndor y nevado), con filas ordinarias y de reposición asterisco; el extracto mezcla BG# y fechas, y esta ficha no publica un BG# adivinado. El serial 26530968 es un número ordinario de ocho dígitos, fuera de las bandas de asterisco de ese pliego. El Bank Note Museum numera el tipo 404e en 01.05.1970, 12.10.1970, 07.08.1971, 20.07.1972, 07.08.1973 y 07.08.1974, sin hilo de seguridad. Numista cita P# 404e para el 7 de agosto de 1973. La tabla BanRep de 1973 registra 68,3 millones de piezas de 1 peso: toda la producción de esa denominación ese año, no la tirada de esta fecha.',
      en: 'Imprenta de Billetes, Bogotá. Banco de la República circulation issue; date on the note 7 August 1973. Published size: 140 × 70 mm. Eight-digit serial, no series letter. González White 2019 lists this date on p. 41 (Bolívar–Santander / condor and snow peak), with ordinary and asterisk-replacement rows; the extract jumbles BG# against dates, and this record does not publish a guessed BG#. Serial 26530968 is an ordinary eight-digit number, outside the asterisk bands on that spread. The Bank Note Museum numbers type 404e on 01.05.1970, 12.10.1970, 07.08.1971, 20.07.1972, 07.08.1973, and 07.08.1974, without a security thread. Numista cites P# 404e for 7 August 1973. BanRep’s 1973 table records 68.3 million 1-peso notes: all production of that face value that year, not this date’s printage.',
    },
    images: {
    ...
    description: {
      es: 'El Banco de la República imprimió este un peso oro en su Imprenta de Billetes, abierta en Bogotá el 23 de octubre de 1959; el primer trabajo de esa planta fue el 1 peso azul (Pick 404). El anverso, en azul sobre fondo policromado naranja, lleva a la izquierda el retrato de Simón Bolívar en uniforme y a la derecha el de Francisco de Paula Santander de civil —el orden inverso al Pick 380 ABNC—. Al centro, el 1 con la leyenda «UN PESO ORO» y «BOGOTA COLOMBIA». Los seriales van en rojo: 26530968, una vez arriba a la derecha y otra abajo a la izquierda. No hay letra de serie. La fecha impresa es «7 DE AGOSTO DE 1973». Las firmas son las de Germán Botero de los Ríos (gerente) y Antonio José Gutiérrez (secretario), el par que Banknote World registra en el Pick 404e.4 del 20 de julio de 1972; González White sitúa a Botero como gerente entre 1970 y 1978. No hay asterisco entre GERENTE y SECRETARIO: no es reposición. El reverso, en azul y naranja, muestra el cóndor andino sobre una roca, el salto y el nevado, el sello de la Libertad («BANCO DE LA REPUBLICA - BOGOTA COLOMBIA») y las cifras 1 con «PESO ORO» a ambos flancos. El tipo 404e, según el Bank Note Museum, cubre 1970–1974 sin hilo de seguridad. Numista agrupa el diseño 1959–1977 bajo N# 205723 y marca el 7 de agosto de 1973, sin hilo, con el año como «1.973». No es el 1 peso oro ABNC de 1945, serie R (Pick 380d), ni el de 1954, serie HH (Pick 380g), ni el conmemorativo de Boyacá de 1953 (Waterlow). Esta pieza de la colección se presenta en funda, sin encapsular.',
      en: 'The Banco de la República printed this one-peso oro at its Imprenta de Billetes, opened in Bogotá on 23 October 1959; that plant’s first job was the blue 1-peso (Pick 404). The face, blue on an orange multicolour underprint, carries at left Simón Bolívar in uniform and at right Francisco de Paula Santander in civilian dress — the reverse of the ABNC Pick 380 order. At center are the figure 1 with the legend “UN PESO ORO” and “BOGOTA COLOMBIA.” The serials are in red: 26530968, once at upper right and once at lower left. There is no series letter. The printed date is “7 DE AGOSTO DE 1973.” The signatures are those of Germán Botero de los Ríos (gerente) and Antonio José Gutiérrez (secretario), the pair Banknote World records on Pick 404e.4 of 20 July 1972; González White places Botero as gerente from 1970 to 1978. There is no asterisk between GERENTE and SECRETARIO: it is not a replacement. The back, in blue and orange, shows the Andean condor on a rock, the falls and the snow peak, Liberty’s seal (“BANCO DE LA REPUBLICA - BOGOTA COLOMBIA”), and the figures 1 with “PESO ORO” at each flank. Type 404e, per the Bank Note Museum, covers 1970–1974 without a security thread. Numista groups the 1959–1977 design under N# 205723 and marks 7 August 1973, without a thread, with the year as “1.973.” It is not the 1945 Series R ABNC 1 peso oro (Pick 380d), nor the 1954 Series HH (Pick 380g), nor the 1953 Boyacá commemorative (Waterlow). This collection piece is shown in a sleeve, unslabbed.',
    },
    frontCaption: {
    ...
    scarcity: {
      es: 'González White 2019 (p. 41) lista el 7 de agosto de 1973 en el pliego del 1 peso 1959–1977, con filas ordinarias y de reposición asterisco; esta ficha no publica un BG# ni una emisión adivinados a partir del OCR. El Bank Note Museum describe el Pick 404e como las fechas 1970–1974 del 1 peso azul de la Imprenta, sin hilo: Bolívar y Santander al anverso, cóndor y Libertad al reverso. Numista agrupa el diseño bajo N# 205723, índice de rareza 11, y marca la frecuencia de la fecha 07.08.1973, sin hilo, en un 30 % entre quienes poseen el tipo. No es prueba ni espécimen ni reposición. La tabla BanRep de 1973 (68,3 millones de piezas de 1 peso) es un total de denominación-año, no la tirada de esta fecha.',
      en: 'González White 2019 (p. 41) lists 7 August 1973 on the 1959–1977 1-peso spread, with ordinary and asterisk-replacement rows; this record does not publish a guessed BG# or emisión from the OCR. The Bank Note Museum describes Pick 404e as the 1970–1974 dates of the Imprenta’s blue 1-peso, without a thread: Bolívar and Santander on the face, condor and Liberty on the back. Numista groups the design under N# 205723, rarity index 11, and marks the 07.08.1973 no-thread date’s frequency at 30% among owners of the type. It is neither a proof, a specimen, nor a replacement. BanRep’s 1973 table (68.3 million 1-peso notes) is a denomination-year total, not this date’s printage.',
    },
    population: {
    ...
    sources: [
      ...
      },
      {
        ...
        note: {
          es: '07.08.1973: P# 404e; sin hilo de seguridad; año como «1.973»; 140 × 70 mm; Imprenta de Billetes, Bogotá; frecuencia 30 % en el tipo; índice de rareza 11.',
          en: '07.08.1973: P# 404e; no security thread; year as “1.973”; 140 × 70 mm; Imprenta de Billetes, Bogotá; 30% frequency within the type; rarity index 11.',
        },
      },
      {
