...
export const colombiaNotes: ColombiaNote[] = [
  ...
  },
  {
    ...
    printed: {
      es: 'Imprenta de Billetes, Banco de la República, Bogotá. Impreso en tintas sobre papel. Fecha impresa en el anverso, bajo las firmas: 5 de septiembre de 2008. Formato 140 × 70 mm; ocho dígitos, sin letra de serie. González White 2019 numera el 50.000 de Isaacs BG# 802–827 (pp. 136–138) y lista el 5 de septiembre de 2008 como BG# 812, emisión N.D. El Bank Note Museum numera 05.09.2008 como Pick 455l. Numista asigna TBB B992l, Hernández# 657 y el par JDUE / GHC. La producción BanRep de 50.000 pesos en 2008 es 171 millones de piezas: es el total de esa denominación ese año, no la tirada de esta fecha ni de este error. No se publica aquí una tirada.',
      en: 'Imprenta de Billetes, Banco de la República, Bogotá. Printed in inks on paper. Date printed on the face, under the signatures: 5 September 2008. Size 140 × 70 mm; eight digits, no series letter. González White 2019 numbers the Isaacs 50,000 as BG# 802–827 (pp. 136–138) and lists 5 September 2008 as BG# 812, emisión N.D. The Bank Note Museum numbers 05.09.2008 as Pick 455l. Numista assigns TBB B992l, Hernández# 657, and the JDUE / GHC pair. BanRep’s 2008 production of 50,000-peso notes is 171 million pieces: that is every note of that face value that year, not the printage of this date or this error. No printage is published here.',
    },
    images: {
    ...
    scarcity: {
      es: 'González White 2019 (BG# 812, pp. 136–138) no publica cifra de emisión para el 5 de septiembre de 2008 (N.D.). El Bank Note Museum describe Pick 455 como el tipo 2001–2014 de 140 × 70 mm y marca 455l esa fecha. Numista agrupa el diseño bajo N# 208162, con índice de rareza 26, y marca la frecuencia de 05.09.2008 en 0,3 % entre quienes poseen el tipo; esa cifra es de la fecha ordinaria, no de las maculaturas. La tabla BanRep de producción anual atribuye 171 millones de piezas a todos los 50.000 pesos de 2008: no es la tirada de una fecha, de un par de firmas ni de un error de numeración. Dos series que no coinciden son una pieza de vitrina; esta ficha no inventa una población de ese error.',
