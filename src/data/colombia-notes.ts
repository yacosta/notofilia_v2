...
export const colombiaNotes: ColombiaNote[] = [
  ...
  },
  {
    ...
    kicker: {
      es: 'Colombia · Banco de la República · Waterlow / ABNC',
      en: 'Colombia · Banco de la República · Waterlow / ABNC',
    },
    lead: {
    ...
    description: {
      es: 'El Banco de la República encargó este un peso oro del tipo conmemorativo de la Batalla de Boyacá (7 de agosto de 1819). El anverso, en azul sobre fondo policromado, lleva a la izquierda la estatua de Simón Bolívar —González White la identifica como la de Tenerani—, al centro el Puente de Boyacá rotulado en el grabado, y a la derecha el retrato circular de Francisco de Paula Santander en uniforme, que el mismo catálogo atribuye al óleo de Ricardo Acevedo Bernal. Los seriales van en rojo: 60870843, una vez arriba a la derecha y otra abajo a la izquierda. La letra de serie A aparece dos veces. La fecha impresa, a la derecha, es «BOGOTA / COLOMBIA / 9 DE AGOSTO / DE 1959». El pie del anverso lee «WATERLOW & SONS LIMITED. LONDRES». El reverso, en azul, muestra la cabeza de la Libertad con gorro frigio que inscribe «LIBERTAD», las cifras 1 a ambos flancos y el pie «AMERICAN BANK NOTE COMPANY.»: dos imprentas en la misma pieza. Los títulos bajo las firmas son GERENTE y SECRETARIO; los nombres no se leen con certeza a través de la funda y no se publican aquí. Numista asigna Luis Ángel Arango y Eduardo Arias Robledo (LAA, EAR) a la fecha de tipo 7.8.1953; esa atribución no se aplica a esta pieza sin lectura independiente. No es el 1 peso ABNC de Santander y Bolívar (Pick 380) ni el 1 peso azul de la Imprenta de Billetes (Pick 404), cuyo primer trabajo en Bogotá fue el 23 de octubre de 1959. Esta pieza de la colección se presenta en funda transparente de coleccionista, circulada, sin cápsula PMG ni NGC y sin número de certificado.',
      en: 'The Banco de la República ordered this one-peso oro of the commemorative type for the Battle of Boyacá (7 August 1819). The face, blue on a multicolour underprint, carries at left the statue of Simón Bolívar — González White identifies it as Tenerani’s — at center the Puente de Boyacá, captioned on the engraving, and at right the circular portrait of Francisco de Paula Santander in uniform, which the same catalogue attributes to Ricardo Acevedo Bernal’s oil. The serials are in red: 60870843, once at upper right and once at lower left. The series letter A appears twice. The printed date, at right, is “BOGOTA / COLOMBIA / 9 DE AGOSTO / DE 1959.” The face imprint reads “WATERLOW & SONS LIMITED. LONDRES.” The blue back shows Liberty’s head with a Phrygian cap inscribed “LIBERTAD,” the figures 1 at each flank, and the imprint “AMERICAN BANK NOTE COMPANY.”: two printers on one note. The titles under the signatures are GERENTE and SECRETARIO; the names cannot be read with certainty through the sleeve and are not published here. Numista assigns Luis Ángel Arango and Eduardo Arias Robledo (LAA, EAR) to the type date 7.8.1953; that attribution is not applied to this piece without an independent reading. It is not the ABNC Santander-and-Bolívar 1-peso (Pick 380) or the Imprenta de Billetes blue 1-peso (Pick 404), whose first Bogotá job was 23 October 1959. This collection piece is shown in a clear collector’s sleeve, circulated, without a PMG or NGC holder and without a certificate number.',
    },
    frontCaption: {
    ...
    backCaption: {
      es: 'Reverso del 1 peso oro, tipo Pick 398: Libertad con gorro frigio «LIBERTAD» y pie de la American Bank Note Company.',
      en: 'Back of the 1 peso oro, Pick 398 type: Liberty with a Phrygian cap reading “LIBERTAD,” and the American Bank Note Company imprint.',
    },
    scarcity: {
      es: 'González White 2019 (BG# 043, p. 37) publica 100.000.000 de ejemplares para el 7 de agosto de 1953, serie A de ocho dígitos, seriales 00.000.001–100.000.000, y anota que hasta 1959 fue la mayor emisión del banco desde su fundación. El Bank Note Museum describe el Pick 398 como esa fecha, Waterlow, con el puente al anverso y la Libertad al reverso. Numista agrupa el tipo bajo N# 213495 (P# 398 / TBB B938 / Hernández 44 / BG# 43) y lista solo el 7.8.1953, serie A. Esta pieza lleva fecha 9 de agosto de 1959 e imprentas mixtas; no se publica una tirada aparte para esa fecha ni para el emparejamiento Waterlow–ABNC. No es prueba ni espécimen. Esta ficha no sustituye la emisión BG# por un total BanRep de denominación-año.',
      en: 'González White 2019 (BG# 043, p. 37) publishes 100,000,000 notes for 7 August 1953, eight-digit Series A, serials 00.000.001–100.000.000, and notes that until 1959 it was the bank’s largest issue since its founding. The Bank Note Museum describes Pick 398 as that date, Waterlow, with the bridge on the face and Liberty on the back. Numista groups the type under N# 213495 (P# 398 / TBB B938 / Hernández 44 / BG# 43) and lists only 7.8.1953, Series A. This piece carries the date 9 August 1959 and mixed imprints; no separate printage is published for that date or for the Waterlow–ABNC pairing. It is neither a proof nor a specimen. This record does not replace the BG# emisión with a BanRep denomination-year total.',
    },
    population: {
