...
export const seriesCopy = {
  es: {
    ...
    heroAlt:
      'Mapa vintage en relieve 3D de Puerto Rico sobre pergamino, con El Morro, Vieques y Culebra, sellos postales y el título Puerto Rico',
    intro: [
  ...
  en: {
    ...
    heroAlt:
      'Vintage 3D relief map of Puerto Rico on parchment, with El Morro, Vieques and Culebra, postage stamps, and the title Puerto Rico',
    intro: [
