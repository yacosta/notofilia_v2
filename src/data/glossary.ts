...
const glossaryTermRecords: GlossaryTermRecord[] = [
  ...
  },
  {
    ...
    definition: { es: "Fichas privadas de cobre, latón o metal blanco acuñadas en Estados Unidos sobre todo entre 1832 y 1844, en el módulo del large cent, cuando el público atesoró la moneda federal tras el Pánico de 1837. Sirvieron de menuda y de sátira política; hoy se catalogan como exonumia (Low / Rulau). Esta colección documenta el HT-34 (Low-20) de 1837, burro y tortuga SUB TREASURY.", en: "Privately struck United States tokens in copper, brass, or white metal, mainly 1832–1844, on the large-cent module, when the public hoarded federal coin after the Panic of 1837. They served as small change and as political satire; today they are catalogued as exonumia (Low / Rulau). This collection records the 1837 HT-34 (Low-20), donkey and SUB TREASURY tortoise." },
