...
const glossaryTermRecords: GlossaryTermRecord[] = [
  ...
  },
  {
    ...
    definition: { es: "Papel de curso legal emitido por el Sistema de la Reserva Federal de Estados Unidos desde 1914, hoy el único tipo federal que se pone en circulación. El sello y el distrito (letra y número) lo distinguen de los certificados de plata o de los United States Notes. En esta colección figuran, entre otros, los 10 dólares serie 1934 / 1934 A de varios distritos, el 10 dólares HAWAII Fr. 2303 y el 20 dólares HAWAII Fr. 2305.", en: "Legal-tender paper issued by the United States Federal Reserve System since 1914, today the only federal type still placed in circulation. The seal and the district (letter and number) distinguish it from Silver Certificates or United States Notes. This collection includes, among others, Series 1934 / 1934A $10 notes from several districts, the HAWAII $10 Fr. 2303, and the HAWAII $20 Fr. 2305." },
  ...
  },
  {
    ...
    definition: { es: "Fichas privadas de cobre, latón o metal blanco acuñadas en Estados Unidos sobre todo entre 1832 y 1844, en el módulo del large cent, cuando el público atesoró la moneda federal tras el Pánico de 1837. Sirvieron de menuda, de sátira política y de anuncio comercial; hoy se catalogan como exonumia (Low / Rulau). Esta colección documenta el HT-10A (Low-9B) de 1834, jabalí y busto de Jackson, el HT-34 (Low-20) de 1837, burro y tortuga SUB TREASURY, y la store card de John J. Adams, HT-181 (Low-300), hacia 1835.", en: "Privately struck United States tokens in copper, brass, or white metal, mainly 1832–1844, on the large-cent module, when the public hoarded federal coin after the Panic of 1837. They served as small change, political satire, and commercial advertising; today they are catalogued as exonumia (Low / Rulau). This collection records the 1834 HT-10A (Low-9B), running boar and Jackson bust, the 1837 HT-34 (Low-20), donkey and SUB TREASURY tortoise, and the John J. Adams store card, HT-181 (Low-300), circa 1835." },
