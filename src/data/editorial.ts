...
const catalogRelatedTitles: Record<string, LocalizedText> = {
  ...
  '/coleccion/estados-unidos-numismatica/ht-10a-1834-jabali/': {
...
const catalogRelatedDeks: Record<string, LocalizedText> = {
  ...
  '/coleccion/estados-unidos-numismatica/fichas-hard-times/': {
    es: 'La vitrina de menuda privada de 1832–1844: el HT-10A de 1834, el HT-34 de 1837 y la store card HT-181.',
    en: 'The 1832–1844 private small-change case: the 1834 HT-10A, the 1837 HT-34, and the HT-181 store card.',
  },
  '/coleccion/estados-unidos-numismatica/ht-34-1837-burro-tortuga/': {
  ...
  '/coleccion/estados-unidos-numismatica/ht-10a-1834-jabali/': {
    es: 'La ficha HT-10A (Low-9B) de 1834 en la colección virtual.',
    en: 'The 1834 HT-10A (Low-9B) record in the virtual collection.',
  },
  '/coleccion/estados-unidos-numismatica/1-dolar-trump-1776-2026/': {
