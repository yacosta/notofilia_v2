...
export const coinageSources: CatalogSource[] = [
  ...
  },
  {
    ...
    note: {
      es: 'Exposición permanente abierta en diciembre de 1996 en la manzana de la ceca; decreto 1584 de 1975 (monumento nacional).',
      en: 'Permanent exhibition opened in December 1996 on the mint block; decree 1584 of 1975 (national monument).',
    },
  },
  {
...
export const coinageCopy = {
  es: {
    ...
    intro: [
      ...
      'La República de 1886 heredó el peso. Las cecas se paralizaron hacia 1890; las cocobolas de 50 centavos, con el perfil de Soledad Román, se encargaron en Nueva York. El Banco de la República, en su cronología, asumió la Casa de Bogotá en 1946 y compró la de Medellín en 1953. El 9 de abril de 1948 la casa resistió el Bogotazo. En 1982 abrió la fábrica de cospeles en Ibagué, propuesta de Luis Guillermo Correa, y en 1987 trasladó allí la acuñación. La Ley 31 de 1993 incorporó la casa al banco emisor. En diciembre de 1996 abrió la exposición permanente. La familia de 2012 —biodiversidad y agua— ganó al año siguiente el premio a la mejor serie circulante. Esta vitrina reúne ese arco: de las macuquinas de Santa Fe al peso actual.',
    ],
  ...
  en: {
    ...
    intro: [
      'Colombian coin was born in Santa Fe, not in a central bank. Around 1590 Philip II ordered a mint that never opened. In 1620 Philip III authorized Alonso Turrillo de Yebra; the next year he hammered gold — for the first time in the Americas — and silver, the N.R. cobs. The Banco de la República dates that founding to 1620; the Casa de Moneda Museum recalls the work of 1621, in one of the city’s earliest houses. Until then trade ran on tejuelos and gold dust. Those escudos and reales, with cob silver arriving from Mexico and Peru, were the viceroyalty’s circulating coin.',
      ...
      'The Republic of 1886 inherited the peso. The mints stalled about 1890; the 50-centavo cocobolas, with Soledad Román’s profile, were ordered in New York. The Banco de la República, on its own timeline, took over the Bogotá mint in 1946 and bought Medellín in 1953. On 9 April 1948 the house held in the Bogotazo. In 1982 the Ibagué planchet factory opened, on Luis Guillermo Correa’s proposal, and in 1987 striking moved there. Law 31 of 1993 folded the house into the issuing bank. The permanent exhibition opened in December 1996. The 2012 family — biodiversity and water — won the next year’s prize for best circulating series. This case gathers that arc: from the cobs of Santa Fe to the peso now in the pocket.',
    ],
