...
export const chinaChapters: ChinaChapter[] = [
  {
    ...
    body: {
      es: 'El papel moneda nació en China. A finales del siglo X, las casas mercantiles de Sichuan —donde circulaba un numerario de hierro demasiado pesado para el comercio de larga distancia— emitieron pagarés llamados jiaozi. Tras quiebras y corridas, el gobierno Song fundó en 1023 la Oficina de Billetes (交子務) en Yizhou, la actual Chengdu, y en 1024 puso en circulación el primer jiaozi oficial del mundo: un título estatal, con sello y número de serie, canjeable por una comisión. Más tarde llegaron el qianyin y, desde 1161, el huizi del Song meridional; en el norte, los Jin imitaron el sistema con el jiaochao. Bajo Kublai Kan, la dinastía Yuan hizo del Zhongtong Chao (1260) una moneda de imperio. El sobreemisión acabó por destruir esa confianza; al caer Yuan, el experimento imperial del papel quedó herido.',
