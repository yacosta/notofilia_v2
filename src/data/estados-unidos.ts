...
export const unitedStatesNotes: UnitedStatesNote[] = [
  ...
  },
  {
    ...
    signatures: {
      es: 'Dos firmas manuscritas; la inferior se lee Mifflin. Newman incluye a Joseph Mifflin entre los firmantes de la emisión del 1 de octubre de 1773. La firma superior no se transcribe con certeza en esta fotografía.',
      en: 'Two manuscript signatures; the lower one reads Mifflin. Newman lists Joseph Mifflin among the signers of the 1 October 1773 issue. The upper signature is not confidently transcribed from this photograph.',
    },
    printed: {
    ...
    lead: {
      es: 'Bill of credit de 5 chelines —una corona— de la Asamblea General de Pensilvania, 1 de octubre de 1773. Anverso con el escudo provincial y franja roja; reverso con escena agrícola y «To Counterfeit is Death». Serial manuscrito 9733.',
      en: 'A 5-shilling bill of credit — one crown — of the Pennsylvania General Assembly, 1 October 1773. Face with the provincial arms and a red stripe; back with a farm scene and “To Counterfeit is Death.” Manuscript serial 9733.',
    },
    description: {
      es: 'Los 5 chelines del 1 de octubre de 1773 (Friedberg PA-166; Pick S-2540; Numista N#406969) son un bill of credit de la provincia de Pensilvania, no un Continental del Congreso. El anverso, en negro con una franja vertical roja a la derecha, titula FIVE SHILLINGS en los cuatro lados y cita un acto de la General Assembly «passed in the 13th Year of the Reign of His Majesty GEORGE the Third. Dated the First Day of October, 1773» —el long s de First se lee a menudo como f. El texto promete A CROWN in Gold or Silver, containing the Value of FIVE SHILLINGS Lawful Money. Newman señala que el número de coronas del tipo se corresponde con las cinco denominaciones altas de la emisión; en este cinco hay una. Al centro, el escudo provincial con un caballo y el lema VIRTUE LIBERTY AND INDEPENDENCE. El recuadro No. lleva el serial manuscrito 9733. Hay dos firmas manuscritas; la inferior se lee Mifflin. El reverso no es la nature print de hoja de los Continentals: Newman lo describe como un grabado fundido de una escena agrícola. Encima se lee To Counterfeit is Death y FIVE SHILLINGS; abajo, Printed by HALL and SELLERS. No es el 5 dólares continental de 1779 de la misma imprenta (Fr. CC-91) ni las demás denominaciones de esta fecha —18 peniques, 2, 2 s 6 d, 10, 15, 20 y 50 chelines—. La pieza, circulada y sin encapsular, se presenta sobre fondo neutro.',
      en: 'The 5 shillings of 1 October 1773 (Friedberg PA-166; Pick S-2540; Numista N#406969) is a Province of Pennsylvania bill of credit, not a Continental of Congress. The face, black with a vertical red stripe at right, titles FIVE SHILLINGS on all four sides and cites an act of the General Assembly “passed in the 13th Year of the Reign of His Majesty GEORGE the Third. Dated the First Day of October, 1773” — the long s in First is often read as an f. The text promises A CROWN in Gold or Silver, containing the Value of FIVE SHILLINGS Lawful Money. Newman notes that the number of crowns on the type is keyed to the five highest denominations of the issue; this five has one. At center sit the provincial arms with a horse and the motto VIRTUE LIBERTY AND INDEPENDENCE. The No. field carries manuscript serial 9733. There are two manuscript signatures; the lower one reads Mifflin. The back is not the leaf nature print of the Continentals: Newman describes a cast cut of a farming scene. Above it stand To Counterfeit is Death and FIVE SHILLINGS; below, Printed by HALL and SELLERS. It is not the 1779 Continental $5 from the same shop (Fr. CC-91), nor the other denominations of this date — 18 pence, 2s, 2s6d, 10s, 15s, 20s, and 50s. The collection note, circulated and unslabbed, is shown on a neutral ground.',
    },
    history: [
      {
        es: 'El 1 de febrero de 1773 la Asamblea de Pensilvania autorizó 150.000 libras en bills of credit para reactivar el sistema del Loan Office: préstamos hipotecarios que devolvían papel a la tesorería provincial. Newman fecha la emisión impresa el 1 de octubre de 1773 y sitúa la imprenta en Hall and Sellers, Filadelfia, herederos de la prensa de Benjamin Franklin. El papel lleva mica y fibras azules. En las cuatro denominaciones más altas el anverso se imprimió en rojo y negro a la vez; Newman apunta a plantillas de papel maché que permitían aplicar las dos tintas en una sola pasada. En este 5 chelines la tinta roja marca la orla derecha.',
        en: 'On 1 February 1773 the Pennsylvania Assembly authorized £150,000 in bills of credit to revive the Loan Office: mortgage loans that returned paper to the provincial treasury. Newman dates the printed issue to 1 October 1773 and places the shop with Hall and Sellers, Philadelphia, successors to Benjamin Franklin’s press. The paper carries mica and blue fibers. On the four highest denominations the face was printed red and black at once; Newman points to papier-mâché stencil plates that let both inks sit in one impression. On this 5 shillings the red ink marks the right border.',
      },
      {
        es: 'Dos años después, el Congreso Continental usaría la misma casa —y, en los reversos, nature prints de hojas— para el papel de la independencia. Este cinco de 1773 sigue fechado en el año 13 de Jorge III y promete una corona en oro o plata, no dólares españoles. La amenaza To Counterfeit is Death es la fórmula penal impresa en el reverso, no un lema ornamental. Esta ficha describe el objeto físico; no afirma el estado de plancha ni un censo de certificación para el serial 9733.',
        en: 'Two years later the Continental Congress would use the same shop — and, on the backs, leaf nature prints — for the paper of independence. This 1773 five is still dated in the 13th year of George III and promises a crown in gold or silver, not Spanish milled dollars. To Counterfeit is Death is the printed penal warning on the back, not an ornamental motto. This record describes the physical object; it does not assert a plate state or a grading census for serial 9733.',
      },
    ],
    historyHeading: {
