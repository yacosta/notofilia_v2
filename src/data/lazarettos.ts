...
export const lazarettosSources: CatalogSource[] = [
  ...
  },
  {
    ...
    note: {
      es: 'Glosario: coscojas de Palonegro (1902), distintas de la moneda exclusiva de los lazaretos. No se publican precios.',
      en: 'Glossary: Palonegro coscojas (1902), distinct from exclusive lazaretto coinage. Prices are not published.',
    },
  },
];
