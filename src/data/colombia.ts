...
export const colombiaChapters: ColombiaChapter[] = [
  ...
  },
  {
    ...
    lead: {
      es: 'Ley 25 de 1923, Misión Kemmerer, peso oro, provisionales de 1923, ABNC, De La Rue e Imprenta de Billetes.',
      en: 'Law 25 of 1923, the Kemmerer Mission, the gold peso, 1923 provisionals, ABNC, De La Rue, and the Imprenta de Billetes.',
    },
    body: {
      es: 'Tras años de crisis, el gobierno de Pedro Nel Ospina pidió un comité de expertos para reformar las condiciones económicas del país. En marzo de 1923 contrató a Edwin W. Kemmerer, el economista estadounidense conocido como «money doctor». La Ley 25 de 1923, sobre sus recomendaciones, creó el Banco de la República como sociedad de capital mixto —gobierno y bancos comerciales— con 10 millones de pesos oro y el monopolio de emitir la moneda legal. Debía abrir en enero de 1924; la corrida contra el Banco López adelantó la puerta al 23 de julio de 1923. El presidente Ospina hizo traer de la Casa de Moneda de Medellín certificados de oro grabados por la American Bank Note Company y se resellaron como «BANCO DE LA REPÚBLICA — BILLETE PROVISIONAL». La serie regular de pesos oro —así se llamó el papel para señalar su respaldo y su estabilidad— siguió en Nueva York. En 1931 el banco asumió el control del metal y se perdió la convertibilidad. A mediados de siglo Thomas De La Rue imprimió junto a la ABNC. El 23 de octubre de 1959 abrió en Bogotá la Imprenta de Billetes; su primer trabajo fue el 1 peso (Pick 404). En 1973 el Estado adquirió casi todas las acciones privadas (Ley 7.ª). La Constitución de 1991 le dio autonomía institucional, ajena al Ejecutivo, con mandato de preservar el poder adquisitivo. Esta vitrina documenta el 10 pesos oro de 1943 (Pick 389b), el 2 pesos oro de 1944 (Pick 390b) y el de 1955 (Pick 390d), la reposición de 10 pesos oro de 1976 (Pick 407f / TBB B950kr) y el espécimen de 2.000 pesos oro de 1983 (Pick 430as), de De La Rue.',
      en: 'After years of financial crises, Pedro Nel Ospina’s government asked an expert committee to study and reform the country’s economic conditions. In March 1923 it hired Edwin W. Kemmerer, the American economist widely known as a “money doctor.” Law 25 of 1923, on his recommendations, created the Banco de la República as a mixed-capital company — government and commercial banks — with 10 million gold pesos and the exclusive right to issue legal tender. It was to open in January 1924; a run on the Banco López brought the doors forward to 23 July 1923. President Ospina had gold certificates engraved by the American Bank Note Company flown from the Medellín mint and overstamped “BANCO DE LA REPÚBLICA — BILLETE PROVISIONAL.” The regular pesos-oro series — the paper was so named to signal its backing and its stability — followed from New York. In 1931 the bank took control of the metal and convertibility ended. Mid-century Thomas De La Rue printed alongside ABNC. On 23 October 1959 the Imprenta de Billetes opened in Bogotá; its first job was the 1-peso (Pick 404). In 1973 the state bought nearly all private shares (Law 7). The 1991 Constitution gave the bank institutional autonomy from the executive, with a mandate to preserve purchasing power. This case documents the 1943 10 pesos oro (Pick 389b), the 1944 2 pesos oro (Pick 390b), the 1955 2 pesos oro (Pick 390d), the 1976 10 pesos oro replacement (Pick 407f / TBB B950kr), and the 1983 2,000 pesos oro specimen (Pick 430as), by De La Rue.',
    },
  },
  {
...
export const seriesCopy = {
  es: {
    ...
    holdingsIntro:
      'Las fichas se publican a medida que se documentan las piezas. La banca libre abre con las pruebas ABNC del Banco Hipotecario (1881) y del Banco de Rio Hacha (1883). El Banco de la República, con el 10 pesos oro de 1943, el 2 pesos oro de 1944 y el de 1955, la reposición de 10 pesos oro de 1976 y el espécimen de 2.000 pesos oro de 1983. Las familias modernas, con el 2.000 pesos de 2008 (serial capicúa binario 10000001) y el 20.000 pesos de 2017 (serial AF51355141). El Banco Central de 1905 se cuenta en los capítulos; aún no tiene ficha.',
  ...
  en: {
    ...
    intro: [
      ...
      'In 1880–1881, under Rafael Núñez’s Regeneración, the Banco Nacional was born (Law 39 of 1880): to handle state funds, issue notes, and lend to the treasury. At first it coexisted with private issues. In 1886 the government ended convertibility: Decree 104 and Law 87 made the paper peso the forced-tender monetary unit. Law 57 of 1887 suspended private banks’ right to issue while the Nacional held the exclusive privilege. Opaque issue depreciated the bill; for those excesses, Law 70 of 1894 ordered the institute liquidated. Astrid Romero places the final closure on 1 January 1896. The Thousand Days’ War (1899–1902) set off another surge of unbacked paper — from the government and from regional commanders — and a devastating inflation. In 1909 the Conversion Board rated 100 paper pesos to 1 gold peso. Even in the early 1910s old Nacional bills were still in circulation.',
      'To stabilize the postwar economy, Rafael Reyes created the Banco Central de Colombia in 1905. It was a short-lived issuer: in 1909, after Reyes fell, its privilege of issue was withdrawn. It is not the bank of 1923. Law 25 of 1923, the fruit of the Kemmerer Mission — the “money doctor” hired by Pedro Nel Ospina — created the Banco de la República with mixed capital, 10 million gold pesos, and the monopoly of legal-tender issue. A run on the Banco López brought the opening forward to 23 July 1923: gold certificates from the Medellín mint were overstamped as provisional notes. The first regular issues were engraved by the American Bank Note Company; the paper was called peso oro to signal its backing. Gold convertibility ended in 1931. Thomas De La Rue printed at mid-century. On 23 October 1959 the Imprenta de Billetes opened in Bogotá, with the 1-peso (Pick 404). In 1973 the state nationalized nearly all the capital; the 1991 Constitution fixed the bank’s autonomy. This case documents the 1943 10 pesos oro (Pick 389b), the 1944 2 pesos oro (Pick 390b), the 1955 2 pesos oro (Pick 390d), the 1976 10 pesos oro replacement (Pick 407f / TBB B950kr), and the 1983 2,000 pesos oro specimen (Pick 430as), printed by Thomas De La Rue.',
    ...
    holdingsIntro:
      'Note pages are published as pieces are documented. Free banking opens with the ABNC proofs of the Banco Hipotecario (1881) and the Banco de Rio Hacha (1883). The Banco de la República chapter holds the 1943 10 pesos oro, the 1944 2 pesos oro, the 1955 2 pesos oro, the 1976 10 pesos oro replacement, and the 1983 2,000 pesos oro specimen. The modern families chapter holds the 2008 2,000 pesos with binary radar serial 10000001 and the 2017 20,000 pesos, serial AF51355141. The 1905 Banco Central is told in the chapters; it does not yet have a note page.',
