...
export const seriesCopy = {
  es: {
    ...
    intro: [
      ...
      'La Ley 25 de 1923, fruto de la Misión Kemmerer contratada por Pedro Nel Ospina, creó el Banco de la República con el monopolio de emitir la moneda legal. Los primeros billetes oficiales los grabó la American Bank Note Company. La convertibilidad en oro se perdió en 1931. Desde entonces el peso es emisión centralizada. Esta vitrina documenta, en fichas separadas, el anverso y el reverso de un 10 pesos oro de 1943 (Pick 389b).',
    ],
    holdingsTitle: 'El catálogo',
    holdingsIntro:
      'Las fichas se publican a medida que se documentan las piezas. La banca libre abre con las pruebas ABNC del 5 pesos del Banco de Rio Hacha (1883). El Banco de la República, con el anverso y el reverso por separado de un 10 pesos oro de 1943.',
  ...
  en: {
    ...
    intro: [
      ...
      'The modern note arrived in the 1870s with free banking. The Banco de Bogotá (1870) was the first private issuer the market broadly accepted. Dozens of regional banks — Antioquia, Colombia, Bolívar, Medellín, Pamplona, the Norte, the Cauca, Rio Hacha — ordered plates in New York and London, with metallic convertibility. Those issues, with proofs and specimens, are the historical core of this case. Free banking opens with the pair of ABNC proofs of the Rio Hacha 5 pesos, 1883.',
