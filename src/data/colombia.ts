...
export type ColombiaPlaceholderNote = {
  title: LocalizedText;
  meta: LocalizedText;
};
...
export type ColombiaChapter = {
  ...
  lead: LocalizedText;
  body: LocalizedText;
  placeholder: ColombiaPlaceholderNote;
};
...
export const colombiaChapters: ColombiaChapter[] = [
  {
    ...
    placeholder: {
      title: {
        es: '1 real · Cartagena, 1813',
        en: '1 real · Cartagena, 1813',
      },
      meta: {
        es: 'Estado de Cartagena · Gutiérrez de Piñeres',
        en: 'State of Cartagena · Gutiérrez de Piñeres',
      },
    },
  },
  {
    ...
    placeholder: {
      title: {
        es: '1 peso · Banco de Bogotá',
        en: '1 peso · Banco de Bogotá',
      },
      meta: {
        es: 'Banca libre · década de 1870',
        en: 'Free banking · 1870s',
      },
    },
  },
  {
    ...
    placeholder: {
      title: {
        es: '1 peso · Banco Nacional',
        en: '1 peso · Banco Nacional',
      },
      meta: {
        es: 'Curso forzoso · Regeneración',
        en: 'Forced tender · Regeneración',
      },
    },
  },
  {
    ...
    placeholder: {
      title: {
        es: '1 peso oro · Banco de la República',
        en: '1 peso oro · Banco de la República',
      },
      meta: {
        es: 'American Bank Note Company · desde 1923',
        en: 'American Bank Note Company · from 1923',
      },
    },
  },
];
...
export const seriesCopy = {
  es: {
    ...
    placeholderStatus: 'Ficha pendiente',
  ...
  en: {
    ...
    placeholderImage: 'Image forthcoming',
    placeholderStatus: 'Note page forthcoming',
