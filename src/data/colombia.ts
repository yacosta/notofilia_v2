...
export const seriesCopy = {
  es: {
    ...
    intro: [
      ...
      'La Ley 25 de 1923, fruto de la Misión Kemmerer contratada por Pedro Nel Ospina, creó el Banco de la República con el monopolio de emitir la moneda legal. Los primeros billetes oficiales los grabó la American Bank Note Company. La convertibilidad en oro se perdió en 1931. Desde entonces el peso es emisión centralizada. Esta vitrina documenta el 10 pesos oro de 1943 (Pick 389b), con anverso y reverso en la misma ficha.',
    ],
    holdingsTitle: 'El catálogo',
    holdingsIntro:
      'Las fichas se publican a medida que se documentan las piezas. La banca libre abre con las pruebas ABNC del 5 pesos del Banco de Rio Hacha (1883). El Banco de la República, con el 10 pesos oro de 1943.',
