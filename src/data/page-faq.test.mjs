...
describe('FAQ copy for guides and country pages', () => {
  ...
  it('records Victory Series denominations, signatures, and Mickey Mouse context', () => {
    const philippines = seriesFaqs.philippines;
    const es = localizeFaq(philippines, 'es');
    const en = localizeFaq(philippines, 'en');
