...
export const seriesFaqs: Record<string, FaqItem[]> = {
  colombia: [
    {
      ...
      answer: {
        es: 'La vitrina cubre independencia, banca libre, Banco Nacional, Junta de Conversión, el Banco de la República, tiquetes de transporte, bonos políticos de recaudo y errores de impresión, con fichas publicadas a medida que se fotografían las piezas. No es un catálogo completo de todos los Pick colombianos.',
        en: 'The case covers independence issues, free banking, the Banco Nacional, the Conversion Board, the Banco de la República, transport tickets, political fundraising bonds, and printing errors, with note pages published as pieces are photographed. It is not a complete catalog of every Colombian Pick number.',
      },
    },
    {
      question: {
  ...
  'united-states': [
    ...
    },
    {
      ...
      answer: {
        es: 'Es un Federal Reserve Note de emergencia, Fr. 2305, distrito L / 12 de San Francisco, firmas Julian–Morgenthau, sello y seriales marrones y la sobreimpresión HAWAII. La serie 1934 A nombra el tipo, no el año de numeración: este ejemplar, serial L86654132A, bloque L–A, se numeró en 1944. Circulada, sin encapsular. No es el Fr. 2304 de 1934 sin letra, ni el 1 dólar HAWAII serial S40499058C, ni el 10 dólares HAWAII serial L45104670B.',
        en: 'It is an emergency Federal Reserve Note, Fr. 2305, San Francisco district L / 12, Julian–Morgenthau signatures, brown seal and serials, and the HAWAII overprint. Series 1934A names the type, not the numbering year: this piece, serial L86654132A, L–A block, was numbered in 1944. Circulated, unslabbed. It is not Fr. 2304 (1934 without a letter), the HAWAII $1, serial S40499058C, or the HAWAII $10, serial L45104670B.',
      },
    },
    {
      question: {
        es: '¿Qué es el 10 dólares HAWAII serie 1934 A?',
        en: 'What is the Series 1934A HAWAII $10?',
      },
      answer: {
        es: 'Es un Federal Reserve Note de emergencia, P#40 (Fr. 2303), distrito L / 12 de San Francisco, firmas Julian–Morgenthau, sello y seriales marrones y la sobreimpresión HAWAII. La serie 1934 A nombra el tipo, no el año de numeración. Este ejemplar es el serial L45104670B, bloque L–B, plancha de anverso L164 y reverso 903. Circulada, sin encapsular. No es el 20 dólares Fr. 2305, serial L86654132A, ni el 1 dólar HAWAII serial S40499058C.',
        en: 'It is an emergency Federal Reserve Note, P#40 (Fr. 2303), San Francisco district L / 12, Julian–Morgenthau signatures, brown seal and serials, and the HAWAII overprint. Series 1934A names the type, not the numbering year. This piece is serial L45104670B, L–B block, face plate L164 and back plate 903. Circulated, unslabbed. It is not the $20 Fr. 2305, serial L86654132A, or the HAWAII $1, serial S40499058C.',
      },
    },
    {
      question: {
