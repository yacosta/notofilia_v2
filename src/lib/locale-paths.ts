...
export const PATH_PREFIX_PAIRS: PathPair[] = [
  ...
  {
    es: '/coleccion/estados-unidos/1000-dolares-serie-1934a-nueva-york/',
    en: '/collection/united-states/1000-dollars-series-1934a-new-york/',
    aliases: ['/coleccion/united-states/1000-dollars-series-1934a-new-york/'],
  },
  {
    es: '/coleccion/estados-unidos/500-dolares-serie-1934a-nueva-york/',
    en: '/collection/united-states/500-dollars-series-1934a-new-york/',
    aliases: ['/coleccion/united-states/500-dollars-series-1934a-new-york/'],
  },
  {
  ...
  {
    es: '/coleccion/estados-unidos/rency/life-is-beautiful-life-spray/',
    en: '/collection/united-states/rency/life-is-beautiful-life-spray/',
    aliases: [
      '/coleccion/united-states/rency/life-is-beautiful-life-spray/',
      '/coleccion/estados-unidos/renci/life-is-beautiful-life-spray/',
      '/collection/united-states/renci/life-is-beautiful-life-spray/',
    ],
  },
  {
  ...
  {
    es: '/coleccion/estados-unidos/miscelaneos/scrip-baraboo-jubileo-1933/1-dolar-ringling-bros-a2002/',
    en: '/collection/united-states/miscellaneous/baraboo-golden-jubilee-scrip-1933/1-dollar-ringling-bros-a2002/',
    aliases: ['/coleccion/united-states/miscellaneous/baraboo-golden-jubilee-scrip-1933/1-dollar-ringling-bros-a2002/'],
  },
  {
    es: '/coleccion/estados-unidos/miscelaneos/scrip-baraboo-jubileo-1933/10-centavos-chas-ringling-a2844/',
    en: '/collection/united-states/miscellaneous/baraboo-golden-jubilee-scrip-1933/10-cents-chas-ringling-a2844/',
    aliases: ['/coleccion/united-states/miscellaneous/baraboo-golden-jubilee-scrip-1933/10-cents-chas-ringling-a2844/'],
  },
  {
    es: '/coleccion/estados-unidos/miscelaneos/scrip-baraboo-jubileo-1933/15-centavos-al-t-ringling-a2819/',
  ...
  { es: '/coleccion/colombia/independencia/', en: '/collection/colombia/independence/' },
  { es: '/coleccion/colombia/banca-libre/', en: '/collection/colombia/free-banking/' },
  { es: '/coleccion/colombia/banco-nacional/', en: '/collection/colombia/banco-nacional/' },
  { es: '/coleccion/colombia/banco-central/', en: '/collection/colombia/banco-central/' },
  { es: '/coleccion/colombia/junta-conversion/', en: '/collection/colombia/conversion-board/' },
  { es: '/coleccion/colombia/banco-de-la-republica/', en: '/collection/colombia/banco-de-la-republica/' },
  { es: '/coleccion/colombia/familias-modernas/', en: '/collection/colombia/modern-families/' },
  { es: '/coleccion/colombia/tiquetes/', en: '/collection/colombia/tickets/' },
  { es: '/coleccion/colombia/errores/', en: '/collection/colombia/errors/' },
  { es: '/editorial/', en: '/editorial/' },
  { es: '/identificar/billetes-falsos/', en: '/identify/counterfeit-notes/' },
  { es: '/blog/como-se-valora-un-billete-colombiano/', en: '/blog/how-colombian-banknotes-are-valued/' },
  ...
  { es: '/buscar/', en: '/search/' },
  { es: '/identificar/', en: '/identify/' },
  { es: '/herramientas/numeracion-especial/', en: '/tools/fancy-serial-checker/' },
...
export function englishRedirects(): Record<string, string> {
  ...
  const legacyEnglishPrefixes = [
    ...
    '/en/coleccion/estados-unidos/rency/life-is-beautiful-life-spray/',
    ...
    '/en/coleccion/united-states/rency/life-is-beautiful-life-spray/',
    ...
    '/en/coleccion/united-states/miscellaneous/baraboo-golden-jubilee-scrip-1933/10-cents-chas-ringling-a2844/',
    '/en/coleccion/united-states/miscellaneous/baraboo-golden-jubilee-scrip-1933/15-cents-al-t-ringling-a2819/',
    ...
    '/en/coleccion/colombia/5-pesos-oro-1960/',
    '/en/coleccion/colombia/5-pesos-oro-1979/',
    '/en/coleccion/colombia/5-pesos-oro-1980/',
    '/en/coleccion/colombia/2-pesos-oro-1944/',
    '/en/coleccion/colombia/2-pesos-oro-1955/',
    '/en/coleccion/colombia/2-pesos-oro-1977/',
    '/en/coleccion/colombia/10-pesos-oro-1976/',
    '/en/coleccion/colombia/10-pesos-oro-1979/',
    '/en/coleccion/colombia/20-pesos-oro-1983/',
    ...
    '/en/coleccion/colombia/independencia/',
    '/en/coleccion/colombia/banca-libre/',
    '/en/coleccion/colombia/banco-nacional/',
    '/en/coleccion/colombia/banco-central/',
    '/en/coleccion/colombia/junta-conversion/',
    '/en/coleccion/colombia/banco-de-la-republica/',
    '/en/coleccion/colombia/familias-modernas/',
    '/en/coleccion/colombia/tiquetes/',
    '/en/coleccion/colombia/errores/',
    '/en/identificar/billetes-falsos/',
    '/en/blog/como-se-valora-un-billete-colombiano/',
    ...
    '/en/buscar/',
    '/en/identificar/',
    '/en/herramientas/numeracion-especial/',
    '/en/herramientas/',
