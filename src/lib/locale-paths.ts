...
export const PATH_PREFIX_PAIRS: PathPair[] = [
  ...
  {
    es: '/coleccion/polimero-mundial/america-del-norte/canada/5-dolares-laurier/',
    en: '/collection/world-polymer/north-america/canada/5-dollars-laurier/',
  },
  { es: '/coleccion/polimero-mundial/america-del-norte/canada/', en: '/collection/world-polymer/north-america/canada/' },
...
export function englishRedirects(): Record<string, string> {
  ...
  const legacyEnglishPrefixes = [
    ...
    '/en/coleccion/polimero-mundial/america-del-norte/canada/5-dolares-laurier/',
    '/en/coleccion/polimero-mundial/america-del-norte/canada/',
