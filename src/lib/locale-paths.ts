...
export const PATH_PREFIX_PAIRS: PathPair[] = [
  ...
  {
    es: '/coleccion/estados-unidos/2-dolares-certificado-plata-1896/',
    en: '/collection/united-states/2-dollars-silver-certificate-1896/',
    aliases: ['/coleccion/united-states/2-dollars-silver-certificate-1896/'],
  },
  {
    es: '/coleccion/estados-unidos/5-dolares-certificado-plata-1896/',
    en: '/collection/united-states/5-dollars-silver-certificate-1896/',
    aliases: ['/coleccion/united-states/5-dollars-silver-certificate-1896/'],
  },
  {
  ...
  { es: '/coleccion/estados-unidos-numismatica/ht-10a-1834-jabali/', en: '/collection/united-states-numismatics/ht-10a-1834-running-boar/' },
...
export function englishRedirects(): Record<string, string> {
  ...
  const legacyEnglishPrefixes = [
    ...
    '/en/coleccion/united-states/2-dollars-silver-certificate-1896/',
    '/en/coleccion/estados-unidos/5-dolares-certificado-plata-1896/',
    ...
    '/en/coleccion/colombia-numismatica/2-reales-cartagena-1812-1814/',
    ...
    '/en/coleccion/estados-unidos-numismatica/ht-10a-1834-jabali/',
    ...
    '/en/coleccion/united-states-numismatics/ht-10a-1834-running-boar/',
