...
describe('locale path mapping', () => {
  it('translates collection, glossary, news, and contact slugs', () => {
    ...
    assert.equal(
      localizePath('/coleccion/estados-unidos/500-dolares-serie-1934a-nueva-york/', 'en'),
    ...
    assert.equal(
      localizePath('/coleccion/estados-unidos/5-dolares-city-bank-new-haven/', 'en'),
    ...
    assert.equal(
      localizePath('/coleccion/colombia/1-peso-oro-1945/', 'en'),
      '/en/collection/colombia/1-peso-oro-1945/',
    );
    assert.equal(
      localizePath('/coleccion/colombia/medio-peso-oro-1953/', 'en'),
    ...
    assert.equal(
      localizePath('/coleccion/colombia/1-peso-oro-1973/#1-peso-oro-1974', 'en'),
      '/en/collection/colombia/1-peso-oro-1973/#1-peso-oro-1974',
    );
    assert.equal(
    ...
    assert.equal(
      localizePath('/coleccion/colombia/5-pesos-oro-1960/', 'en'),
      '/en/collection/colombia/5-pesos-oro-1960/',
    );
    assert.equal(
      localizePath('/coleccion/colombia/5-pesos-oro-1979/', 'en'),
      '/en/collection/colombia/5-pesos-oro-1979/',
    );
    assert.equal(
      localizePath('/coleccion/colombia/5-pesos-oro-1980/', 'en'),
  ...
  it('redirects old English Spanish slugs', () => {
    ...
    assert.equal(
      redirects['/en/coleccion/estados-unidos/miscelaneos/scrip-baraboo-jubileo-1933/'],
      '/en/collection/united-states/miscellaneous/baraboo-golden-jubilee-scrip-1933/',
    );
    assert.equal(
    ...
    assert.equal(
      redirects['/en/coleccion/estados-unidos/500-dolares-serie-1934a-nueva-york/'],
      '/en/collection/united-states/500-dollars-series-1934a-new-york/',
    );
    assert.equal(
      redirects['/en/coleccion/estados-unidos/1000-dolares-serie-1934a-nueva-york/'],
      '/en/collection/united-states/1000-dollars-series-1934a-new-york/',
    );
    assert.equal(
    ...
    assert.equal(
      redirects['/en/coleccion/estados-unidos/5-dolares-city-bank-new-haven/'],
      '/en/collection/united-states/5-dollars-city-bank-new-haven/',
    );
    assert.equal(
