...
| 50.000 pesos, 5 September 2008, serials 72461316 / 72411316 (mismatched), Imprenta de Billetes (Pick 455l / TBB B992l) | **BG# 812**, pp. 136–138, 140 × 70 mm Isaacs type (BG# 802–827). Printed date **5 SEPT. 2008**, eight digits, no series letter, signatures Uribe / Hernández Correa on that cluster; emisión **N.D.** Public copy uses Bank Note Museum [COL0455](http://www.banknote.ws/COLLECTION/countries/AME/COL/COL0455.htm) for Pick 455l (05.09.2008). Do not treat the BanRep 2008 denomination total (171 million) as this date’s or this error’s printage. Distinct from the 2015 García Márquez over-ink holding (BG# NF50-2). |
