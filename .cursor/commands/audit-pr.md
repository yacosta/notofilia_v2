...
Audit the files changed in this branch against `.cursor/rules/00-site-standards.mdc`, `10-page-types.mdc`, `20-hero.mdc`, `30-catalogue-duplicates.mdc`, and `40-banrep-production.mdc` when Colombia printage or mintage copy changed.
